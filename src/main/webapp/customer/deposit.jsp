...
<div align="center">
    ...
    <form id="frmDeposit" class="form-group needs-validation" method="post">
        <div class="row">
            <div class="col-6">
                <label>Name: </label>
    ...
    <div class="message">
        <c:if test='${requestScope["success"] != null}'>
            <div class="alert alert-success" role="alert" style="position: fixed; bottom: 30px; right: 30px; left: 30px">
